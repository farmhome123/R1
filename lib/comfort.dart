...
import 'package:projectr1/eco.dart';
...
class _comfortState extends State<comfort> {
  ...
  void initState() {
    ...
    super.initState();
    print('โหมด  AI COMFORT');
    print('send to esp RY0101#');
    setState(() {
            ...
            Flexible(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'โหมดนี้จะปรับแต่งคันเร่งให้มีการกระชับขึ้น',
                    style: TextStyle(
                        fontSize: 12, color: Colors.white, fontFamily: 'Kanit'),
                  ),
                  Text(
                    'เร่งแซงได้ดีเน้นขับสบาย',
                    style: TextStyle(
                        fontSize: 12, color: Colors.white, fontFamily: 'Kanit'),
                  ),
                ],
